...
public class CrushingRecipe {
    ...
    public CrushingRecipe(ResourceLocation id, Ingredient input, FluidStack output, ItemStack outputStack, float itemChance, int jumps) {
        this.id = id;
        this.input = input;
    ...
    public CrushingRecipe(ResourceLocation id, Ingredient input, FluidStack output, ItemStack outputStack, int jumps) {
        this(id, input, output, outputStack, 1, jumps);
    }

    public CrushingRecipe(ResourceLocation id, Ingredient input, FluidStack output, int jumps) {
